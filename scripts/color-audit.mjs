...
const DARK = {
  background: okl(0.15, 0.02, 269.18),
  foreground: okl(0.95, 0.01, 238.46),
  card: okl(0.2, 0.02, 266.02),
  primary: okl(0.64, 0.165, 154),
  "primary-foreground": okl(0.15, 0.02, 269.18),
  "primary-strong": okl(0.75, 0.15, 155),
  secondary: okl(0.3, 0.03, 271.05),
  "secondary-foreground": okl(0.95, 0.01, 238.46),
  muted: okl(0.3, 0.03, 271.05),
  "muted-foreground": okl(0.68, 0.03, 269.46),
